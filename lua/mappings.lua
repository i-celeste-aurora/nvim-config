...
-- GitGutter
keymap.set("n", "<A-Down>", "<cmd>GitGutterNextHunk<cr>")
keymap.set("n", "<A-Up>", "<cmd>GitGutterPrevHunk<cr>")
keymap.set("n", "<C-=>", "<cmd>GitGutterPreviewHunk<cr>")
keymap.set("n", "<A-PageUp>", "<cmd>tabnext<cr>")
keymap.set("n", "<A-PageDown>", "<cmd>tabprevious<cr>")
